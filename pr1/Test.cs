...
namespace pr1
{
    public partial class Test : Form
    {
        ...
        private void Test_Load(object sender, EventArgs e)
        {
            ...
            radioButton1.CheckedChanged += new EventHandler(состояние);
            radioButton2.CheckedChanged += new EventHandler(состояние);
            radioButton3.CheckedChanged += new EventHandler(состояние);
            start();
        }
        void start()
        {
        ...
        void состояние(object sender, EventArgs e)
        {
